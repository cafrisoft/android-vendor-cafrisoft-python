...
//LOCAL_CFLAGS += -DPREFIX = "/data/python/bin"
//LOCAL_CFLAGS += -DEXEC_PREFIX = "bin"
...
#define PYMYDBGMSG(fmt, ...) //do { fprintf(stderr, "[Python, %s] ln=%d " fmt, __func__, __LINE__, ##__VA_ARGS__);  fprintf(stderr, "\n"); } while(0)  
#define PYMYINFO(fmt, ...) do { fprintf(stderr, "[PyInfo, %s] ln=%d " fmt, __func__, __LINE__, ##__VA_ARGS__);  fprintf(stderr, "\n"); } while(0)  
