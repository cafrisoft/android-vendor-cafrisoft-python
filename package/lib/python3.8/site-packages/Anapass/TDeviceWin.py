...
class TDeviceWin(TDeviceBase) :
    ...
    def SetServerIPAddr(this, serverIPAddr) :
        ret = this.__Api.TDeviceSetServerIPAddr(this.__DeviceHandle, TString.ConvertToCTypeStrng(serverIPAddr))
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def SetBoardID(this, boardID) : 
        ret = this.__Api.TDeviceSetBoardID(this.__DeviceHandle, boardID)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def NotifyPyStart(this) : 
        ret = this.__Api.TDeviceNotifyPyStart(this.__DeviceHandle)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def NotifyPyStop(this) : 
        ret = this.__Api.TDeviceNotifyPyStop(this.__DeviceHandle)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def ReadReg(this, regAddr, byteOffset, readCount, regValueList, regValueListStartIdx=0) :
        ...
        ret = this.__Api.TDeviceReadRegValue(this.__DeviceHandle, regAddr, byteOffset, readCount, regValueByteArray)
        if ret==1 :
    ...
    def ReadReg1Byte(this, regAddr, byteOffset) :
        ...
        ret = this.__Api.TDeviceReadRegValue1Byte(this.__DeviceHandle, regAddr, byteOffset, regValueArray)
        if ret==1 :
    ...
    def WriteReg(this, regAddr, byteOffset, writeCount, regValueList, writeDataStartIdx=0) :
        ...
        ret = this.__Api.TDeviceWriteRegValue(this.__DeviceHandle, regAddr, byteOffset, writeCount, regValueByteArray)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def WriteReg1Byte(this, regAddr, byteOffset, regValue) :
        ret = this.__Api.TDeviceWriteRegValue1Byte(this.__DeviceHandle, regAddr, byteOffset, c_char(regValue))
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def DD_FB_blank(this, dutIdx, value) :
        ret = this.__Api.TDevice_DD_set_fb0_blank(this.__DeviceHandle, value)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def DD_DSIM_manual_ctrl(this, dutIdx, value) :
        ret = this.__Api.TDevice_DD_set_dsim_manual_ctrl(this.__DeviceHandle, value)
        if ret==1 :
            bflag = True
        else :
            bflag = False;
    ...
    def AgingSetCurJobInfo(this, jobID, status, scIdx, scCount, desc) :
        return this.__Api.TDeviceAgingSetCurJobInfo(this.__DeviceHandle, jobID, status,scIdx, scCount, TString.ConvertToCTypeStrng(desc))

    #TDEVICE_API TED_BOOL TDeviceAgingSetCurSCInfo(TDEVICE_HDL hdl, int scID, int status, int tcIdx, int tcCount, const char* desc);
    def AgingSetCurSCInfo(this, scID, status,tcIdx, tcCount, desc) :
        return this.__Api.TDeviceAgingSetCurSCInfo(this.__DeviceHandle, scID, status,tcIdx, tcCount, TString.ConvertToCTypeStrng(desc))
    ...
    def AgingSetCurTCInfo(this, tcID, status, tcStepIdx, tcStepCount, desc) :
        return this.__Api.TDeviceAgingSetCurTCInfo(this.__DeviceHandle, tcID, status, tcStepIdx, tcStepCount, TString.ConvertToCTypeStrng(desc))

    #TDEVICE_API TED_BOOL TDeviceAgingSetCurTCStepInfo(TDEVICE_HDL hdl, int tcStepID, int status, const char* desc);
    def AgingSetCurTCStepInfo(this, tcStepID, status, desc) :
        return this.__Api.TDeviceAgingSetCurTCStepInfo(this.__DeviceHandle, tcStepID, status, TString.ConvertToCTypeStrng(desc))
    ...
    def AgingMeasureADC(this) :
        ...
        this.__Api.TDeviceAgingMeasureADC(this.__DeviceHandle, meaRes.GetStructData())
