...
class App :
    ...
    def Begin(this) : 
        ...
        this.__TDevice.SetServerIPAddr("127.0.0.1")  
        ...
        if(this.__BoardID > 0) :
            ...
            this.__TDevice.SetBoardID(this.__BoardID)

        #Notify PyStart
        this.__TDevice.NotifyPyStart(this._PyFileName)


    def End(this) :

        #Notify PyStop
        this.__TDevice.NotifyPyStop(this._PyFileName)
