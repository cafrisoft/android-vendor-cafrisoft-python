...
class TDevice :
    ...
    def SetServerIPAddr(this, serverIPAddr) : 
        return this.__TDevice.SetServerIPAddr(serverIPAddr);
    ...
    def ReadReg(this, regAddr, byteOffset, readCount, regValueList, regValueListStartIdx=0) : 
        return this.__TDevice.ReadReg(regAddr, byteOffset, readCount, regValueList, regValueListStartIdx)
