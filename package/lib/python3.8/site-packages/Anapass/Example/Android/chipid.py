...
def print_help() :
    print(" ")
    print("chipid.adc --<option-name>=<options-value> ")
    print(" ")
    print("   <options-name>")
    ...
    print(" ")
    print("   Example:")
    print("       Ex1) chipid.adc  ")
    print("       Ex1) chipid.adc --dut=1 ")
    print(" ")
...
def main(argv) :
    ...
    chipIdList = ted.ANA670X_GetChipID(dutIdx)
    print()

    print("ChipID, DutIdx=%d" % dutIdx)
    # ChipID 읽은 결과 출력
    for value in chipIdList :
        print(hex(value), end=' ')
